...
help:
	...
	@echo "             KurentoRepository.{pdf,epub} in $(BUILDDIR)/html and make a tgz"
	@echo "             as docs-kurento-repository-$(DOC_VERSION).tgz"
...
langdoc:
	  ...
	  rm -rf $(BUILDDIR)/langdoc/kurento-repository-internal
